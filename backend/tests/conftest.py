...
def seeded_event_graph(db_session: Session) -> dict[str, int]:
    ...
    db_session.execute(
        ...
        ),
        {
            ...
            "relevance_rank": 1,
            "metadata": '{"retrieval_scope":"episode","timing_relation":"during","context_window_start":"2026-02-06T00:00:00+00:00","context_window_end":"2026-02-16T00:00:00+00:00","event_themes":["market_stress"],"primary_theme":"market_stress","context_score":0.71}',
        },
    )
    db_session.execute(
        text(
